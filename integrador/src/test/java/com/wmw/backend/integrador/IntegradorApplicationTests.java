...
//		ClienteDTO clienteDTO = ClienteDTO.fromCliente(new Cliente(1l, "Cliente 01", TipoPessoa.FISICA, "136.213.859-24", "(48) 996136359", "cliente01@gmail.com"));
//
...
//		ClienteDTO clienteDTO = ClienteDTO.fromCliente(new Cliente(2l, "Cliente 01", TipoPessoa.JURIDICA, "50.199.526/0001-10", "(48) 996136359", "cliente01@gmail.com"));
//
//		clienteService.cadastrarCliente(clienteDTO);
//		
//		String json = "{\n" +
...
//		ClienteDTO clienteDTO = ClienteDTO.fromCliente(new Cliente(4l, "Cliente 01", TipoPessoa.FISICA, "788.472.170-83", "(48) 996136359", "cliente01@gmail.com"));
//		clienteService.cadastrarCliente(clienteDTO);
//		mockMvc
//		.perform(MockMvcRequestBuilders
//				.get(new URI(uri + "/4")))
...
//		ClienteDTO clienteDTO = ClienteDTO.fromCliente(new Cliente(2l, "Cliente 01", TipoPessoa.FISICA, "952.966.275-04", "(48) 996136359", "cliente01@gmail.com"));
//		clienteService.cadastrarCliente(clienteDTO);
//		mockMvc
//		.perform(MockMvcRequestBuilders
//				.get(new URI(uri + "/10")))
